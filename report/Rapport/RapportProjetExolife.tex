...
Pour ce faire, nous avons analysé un certain nombre d'images en nuances de gris pour en déduire un certain nombre d'informations. Les missions que l'on nous a confié ont chacune un objectif différente et nous avons donc éfféctué différents traitements pour en faire ressortir les informations importantes.

Lors de ce projet, nous avons utilisé le logiciel SciLab permettant de programmer de petits scripts basé sur des matrices de nuaces de gris: les images. Nous avons donc programmé les filtres de base de transformations puis nous avons utilisé ces filtres dans les scripts de mission pour obtenir les résulats finaux.
